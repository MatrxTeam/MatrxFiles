...
if DevRio:get(Matrx.."Rio:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevRio:sadd(Matrx.."Rio:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevRio:get(Matrx.."Rio:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
MatrxName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if MatrxName then 
MatrxNames = DevRio:smembers(Matrx.."Rio:Mute:Names"..msg.chat_id_) or ""
if MatrxNames and MatrxNames[1] then 
for i=1,#MatrxNames do 
if MatrxName:match("(.*)("..MatrxNames[i]..")(.*)") then 
...
DevRio:set(Matrx.."Rio:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevRio:del(Matrx.."Rio:Lock:MuteNames"..msg.chat_id_)
end
end
end
